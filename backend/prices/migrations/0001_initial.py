    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unit', models.CharField(choices=[('kg', 'Kilogram'), ('bag', 'Bag (50kg)'), ('bunch', 'Bunch'), ('piece', 'Piece'), ('liter', 'Liter')], default='kg', max_length=10)),
        ...
        migrations.AddIndex(
            model_name='price',
            index=models.Index(fields=['product', '-date_added'], name='prices_pric_product_date_idx'),
        ),
        migrations.AddIndex(
            model_name='price',
